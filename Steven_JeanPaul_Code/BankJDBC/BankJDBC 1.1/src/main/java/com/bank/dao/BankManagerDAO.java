...
import com.bank.beans.BankManager;

public interface BankManagerDAO {
	// CRUD ops

	// create a super hero
	public abstract void createBankManager(String accountid) throws SQLException;

	// get all of my accounts
	public abstract List<BankManager> getBankManagerList() throws SQLException;
	...
	// structure so
	// we highlight name of project right click and new and
