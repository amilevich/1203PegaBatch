...
public class BankAccountIO {
	public static void main(String[] args) {
		...
		String filename = "src/main/java/com/ex/fileio/obj/bankAccounts.txt"; //Do you know about classpath?
...
//		readBankAccounts(filename);
	...
	static void writeBankAccounts(String filename){
		...
		BankAccount john   = new BankAccount(1, "John1",   120.50);
		BankAccount amy    = new BankAccount(2, "Amy2",    2000);
		BankAccount austin = new BankAccount(3, "Austin3", 460.70);
