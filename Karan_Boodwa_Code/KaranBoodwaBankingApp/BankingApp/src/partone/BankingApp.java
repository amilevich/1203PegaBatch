...
public class BankingApp {
	...
	/*
	 * mainMenu() function handles initial I/O and interaction with above structures
	 */
	...
	/**
	 * login() method used to display io, guiding existing users to log in
	 */
	...
	/**
	 * register() method used to display io, guiding new users to register
	 */
