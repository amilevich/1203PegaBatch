...
public class BubbleSort {
	...
	/*
	 * Bubble Sort: bubblesort() continuously swaps adjacent members of the given
	 * array if they are not in ascending order, eventually resulting in a sorted
	 * array
	 */
	public static void bubbleSort(Integer[] arrayToSort) {
		...
		while (!sorted) {
			/*
			 * flag is initially set to true. If any swap occurs, this flag will be set to
			 * false, as this indicates that the array is not yet sorted once a full pass of
			 * the array is done without any swapping the array will be sorted
			 */
			sorted = true;
