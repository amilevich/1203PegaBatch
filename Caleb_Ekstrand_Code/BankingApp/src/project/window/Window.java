...
public class Window {
	...
	public static void main(String[] args) {
		// Create a new scanner object to recieve inputs
			...
			if (input == 1) {
				...
				if (User.usernameExists(username)) {
					...
					if (current.getPassword().equals(password)) {
						...
						// Implement Logged in code here // figure out what type of account you're looking at would b step 1...
						if (current instanceof Customer) {
							...
							while (running) {
								...
								System.out.println("Options: (1) Withdrawl, (2) Deposit, (3) Transfer, (4) Balance, (5) Request Account or (6) Exit");
								...
								switch (option) {
									case 1: System.out.println("Withdrawl");
											...
											if (((Customer) current).hasAccount(number)) {
												if (((Customer) current).getAccount(number).isActivated()) {
													...
													if ((withdraw > 0) && (withdraw <= ((Customer) current).getBalance(number))) {
									...
									case 3: System.out.println("Transfer");
											...
											if((((Customer) current).hasAccount(account1) && (((Customer) current).getAccount(account1).isActivated()))) {
												System.out.println("Enter the number of the depositing account");
												int account2 = sc.nextInt();
												if((((Customer) current).hasAccount(account2)) && (((Customer) current).getAccount(account2).isActivated())) {
													System.out.println("Enter Amount to Transfer");
													int amount = sc.nextInt();
													if ((amount > 0) && (amount <= ((Customer) current).getBalance(account1))) {
									...
									case 4: System.out.println("Balance");
											...
											break;
									case 5: System.out.println("Request Account");
...
//											}
							...
							while (running) {
								System.out.println("Options: (1) Withdrawl, (2) Deposit, (3) Transfer, (4) View Accounts, (5) View Requests, (6) Cancel Account  or (7) Exit");
								int option = sc.nextInt();
								switch (option) {
									case 1: System.out.println("Withdrawl");
											System.out.println("Enter the number of the account");
											...
											if (Account.accountExists(number)) {
												if (Account.getAccount(number).isActivated()) {
													System.out.println("Enter Amount");
													double withdraw = sc.nextDouble();
													if ((withdraw > 0) && (withdraw <= Account.getAccount(number).getBalance())) {
									...
									case 3: System.out.println("Transfer");
											System.out.println("Enter the number of the withdrawing account");
											int account1 = sc.nextInt();
											if((Account.accountExists(account1)) && (Account.getAccount(account1).isActivated())) {
												System.out.println("Enter the number of the depositing account");
												int account2 = sc.nextInt();
												if((Account.accountExists(account2)) && (Account.getAccount(account2).isActivated())) {
													System.out.println("Enter Amount to Transfer");
													int amount = sc.nextInt();
													if ((amount > 0) && (amount <= (Account.getAccount(account1).getBalance()))) {
											...
											break;
									case 4: System.out.println("View Accounts");
											System.out.println("All accounts");
											for (Account i: Account.getAccounts()) {
												System.out.println(i.toString());
											}
											break;
									case 5: System.out.println("View Requests");
											for (Account i: Account.getAccounts()) {
											...
											break;
									case 6: System.out.println("Cancel Account");
											...
											break;
									case 7: System.out.println("Thank you, Have a Nice Day");
											running = false;
											break;
									default: System.out.println("Invalid input");
											break;
							...
							while (running) {
								...
								int option = sc.nextInt();
								switch (option) {
									case 1: System.out.println("View Accounts");
											System.out.println("All accounts");
											for (Account i: Account.getAccounts()) {
												System.out.println(i.toString());
											}
											break;
									case 2: System.out.println("View Requests");
											for (Account i: Account.getAccounts()) {
												if(i.isActivated() != true) {
													System.out.println(i.toString());
												}
				...
				if (input ==1) {
					...
					if(User.usernameExists(username)) {
						...
						Customer c = new Customer(username, password, name, phoneNumber, address); // create the new user
